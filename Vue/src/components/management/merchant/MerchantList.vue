<template>
    <el-table :data="merchantList" stripe border>
      ...
      <el-table-column class="table-column" min-width="20%" prop="shop_name" label="商户名称" />
      <el-table-column class="table-column" min-width="20%" prop="areaName" label="所述区域" />
      <el-table-column class="table-column" min-width="25%" prop="address" label="详细地址" />
      <el-table-column class="table-column" min-width="10%" prop="liaison" label="联系人" />
      <el-table-column class="table-column" min-width="10%" prop="phone" label="联系电话" />
    ...
    <el-drawer v-model="drawer" size="50%" :with-header="false">
      <MerchantOperation v-if="drawer" :id="selectedId"
    /></el-drawer>
  </template>
