...
urlpatterns = [
    ...
    path('<str:version>/myInfo/', users_api.MyInfoView.as_view(), name='my_info_detail'),
    path('<str:version>/oneInfo/<int:pk>/', users_api.OneInfoView.as_view(), name='one_info_detail'),
